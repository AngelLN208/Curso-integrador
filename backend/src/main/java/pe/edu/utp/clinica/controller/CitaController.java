 ...
 *
 * RF-05: Registrar cita. Solo RECEPCIONISTA/ADMINISTRADOR.
 * RF-06: Reprogramar cita. Solo RECEPCIONISTA/ADMINISTRADOR.
 * RF-07: Buscar citas por filtros. Todos los roles (médico ve las suyas).
 * RF-08: Listar citas. Solo RECEPCIONISTA/ADMINISTRADOR.
 * RF-09: Cancelar cita. Solo RECEPCIONISTA/ADMINISTRADOR.
 *
...
public class CitaController {
        ...
        @Operation(summary = "Registrar cita médica", description = "RF-05: Estado inicial PENDIENTE. "
        ...
        @PreAuthorize("hasAnyRole('RECEPCIONISTA', 'ADMINISTRADOR')")
        @Operation(summary = "Reprogramar cita médica", description = "RF-06: Cambia estado a REPROGRAMADA. "
        ...
        @PreAuthorize("hasAnyRole('RECEPCIONISTA', 'ADMINISTRADOR')")
        @Operation(summary = "Cancelar cita médica", description = "RF-09: Cambia estado a CANCELADA. "
        ...
        @GetMapping
        @PreAuthorize("hasAnyRole('RECEPCIONISTA', 'ADMINISTRADOR')")
        @Operation(summary = "Listar todas las citas", description = "RF-08: Lista con ID, fecha, hora y estado.")
        ...
        @Operation(summary = "Buscar citas por filtros", description = "RF-07: Filtra por pacienteId, medicoId, estado. "
                        + "El médico usa medicoId para ver sus propias citas.")
