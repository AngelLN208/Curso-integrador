      ...
      <div style="border:1px solid var(--border);border-radius:12px;padding:16px;margin-bottom:12px">
        ...
        <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:8px;margin-bottom:12px">
          <div style="background:var(--bg-main);border-radius:8px;padding:8px 10px">
            <div style="font-size:10px;color:var(--text-3)">Presión</div>
            <div style="font-size:13px;font-weight:600;color:var(--text)">${c.presionArterial || '—'}</div>
          </div>
          <div style="background:var(--bg-main);border-radius:8px;padding:8px 10px">
            <div style="font-size:10px;color:var(--text-3)">Temperatura</div>
            <div style="font-size:13px;font-weight:600;color:var(--text)">${c.temperatura ? c.temperatura + ' °C' : '—'}</div>
          </div>
          <div style="background:var(--bg-main);border-radius:8px;padding:8px 10px">
            <div style="font-size:10px;color:var(--text-3)">Peso</div>
            <div style="font-size:13px;font-weight:600;color:var(--text)">${c.peso ? c.peso + ' kg' : '—'}</div>
          </div>
        </div>` : ''}
